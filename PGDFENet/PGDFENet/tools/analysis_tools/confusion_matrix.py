...
def parse_args():
    ...
    parser.add_argument('--config',default='/home/lucid/lwt/code/PETDet/configs/redet/redet_re50_refpn_3x_hrsc_le90.py', help='test config file path')
    parser.add_argument(
        '--prediction_path',default='/home/lucid/lwt/code/PETDet/results.pkl', help='prediction path where test .pkl result')
    parser.add_argument(
        '--save_dir',default='/home/lucid/lwt/code/PETDet/xiaorong', help='directory where confusion matrix will be saved')
    parser.add_argument(
