...
class HRSCDataset(CustomDataset):
    ...
    CLASSES = None
    HRSC_CLASS = ('ship', )
    HRSC_CLASSES = ('ship', 'Nimitz', 'Enterprise', 'Arleigh Burke', 'WhidbeyIsland', 'Perry', 'Sanantonio',
                    'Ticonderoga', 'Austen', 'Tarawa', 'Container', 'OXo|--)', 'Car carrier([]==[])', 'Hovercraft',
                    'CntShip(_|.--.--|_]=', 'Cruise', 'submarine', 'lute', 'Medical', 'Car carrier(======|', 'Midway-class')

    HRSC_CLASSES_ID = ('01', '05', '06', '07', '08', '09', '10',
    ...
    CLASSWISE_PALETTE = ((220, 20, 60), (106, 0, 228), (0, 60, 100), (0, 80, 100), (0, 0, 70), (0, 0, 192), (250, 170, 30),
                         (100, 170, 30), (165, 42, 42), (255, 77, 255), (182, 182, 255), (0, 82, 0), (120, 166, 157),
                         (110, 76, 0), (199, 100, 0), (72, 0, 118), (255, 179, 240), (0, 125, 92), (209, 0, 151),
                         (188, 208, 182), (255, 99, 164))
    ...
    def evaluate(self,
                 ...
                 iou_thr=[0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95],#0.5   [0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95]
                 scale_ranges=None,
                 use_07_metric=True,
                 nproc=4):
