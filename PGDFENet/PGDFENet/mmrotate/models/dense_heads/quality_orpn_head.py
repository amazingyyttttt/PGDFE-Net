...
from ..necks.ffca import SCAM
from ..necks.spp import SPPFCSPC
INF = 1e8
...
class DecoupledAttentionModule(nn.Module):
    ...
    def __init__(self,
        ...
        ##########################################
        self.scam = SCAM(feat_channels*3)
        self.spp = SPPFCSPC(c1=feat_channels*3, c2=feat_channels*3)
        self.conv3x3 = nn.Conv2d(feat_channels, feat_channels, 3, 1, 1)
        ##########################################
