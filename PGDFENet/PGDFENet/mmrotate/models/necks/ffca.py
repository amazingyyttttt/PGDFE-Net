...
#     # FFM_Concat2
#     x1 = torch.randn(1, 64, 128, 128)  # [N, C1, H1, W1]
#     x2 = torch.randn(1, 128, 128, 128)  # [N, C2, H2, W2]
#
#     # 用于 FFM_Concat3
#     x3 = torch.randn(1, 32, 128, 128)  # [N, C3, H3, W3]
#
#     # 实例化 FFM_Concat2 和 FFM_Concat3
#     scam = SCAM(in_channels=256)
#     model_concat2 = FFM_Concat2(dimension=1, Channel1=64, Channel2=128)
#     model_concat3 = FFM_Concat3(dimension=1, Channel1=64, Channel2=128, Channel3=32)
#
#     # 执行前向传播
#     output = scam(x)
#     output2 = model_concat2([x1, x2])
#     output3 = model_concat3([x1, x2, x3])
#
#
#     print("Output size:", output.size())
#     print("Output size of FFM_Concat2:", output2.size())  # 应该为 [1, 192, 128, 128]
#     print("Output size of FFM_Concat3:", output3.size())  # 应该为 [1, 224, 128, 128]